...
echo 'kewmgflkwngjwngjkwngjui;wlgwiugihlu';
...
echo '<h1 class="base-title catalog__title">Проекторы</h1>';

//вывод категорий
//echo '<div class="section-d__name" style="display: flex; justify-content: space-between">';
...
echo '<div class="catalog__products">';
