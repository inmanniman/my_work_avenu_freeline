...
<i class="fa fa-warning"></i>'.$this->diafan->_('Фоновые процессы запускаются автоматически основными модулями для обработки долгосрочных операций. Например, пересчет цен при назначении скидок или отправка рассылки писем тысячам подписчиков.').'</div>';
	}
