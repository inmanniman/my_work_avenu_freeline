...
echo '<section class="block-d block-d_gall block-d_shop block-d_shop_set block-d_shop_item block-d_shop_item_set">';
	...
	'<article class="element-d element-d_card element-d_shop element-d_shop_item js_shop">';
		...
		'<div class="element-d__images">';
			...
			if(! empty($row["img"]))
			{
                ...
                {
                    case 'animation':
                        echo '<a class="_fit" href="'.BASE_PATH.$img["link"].'" data-fancybox="gallery'.$row["id"].'shop">';
                        break;
                    case 'large_image':
