...
class Shop_google extends Diafan
{
	...
	private function get_offers()
	{
		...
		$this->cache["images"] = DB::query_fetch_key_array("SELECT id, name, folder_num, element_id FROM {images} WHERE module_name='shop' AND element_type='element' AND param_id=0 AND trash='0' ORDER BY sort ASC", "element_id");
