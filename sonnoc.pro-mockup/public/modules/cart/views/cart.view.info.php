						...
						foreach ($result["rows"] as $row)
						{
							...
							'<div class="table-d__row">
								...
								'<div class="cell-d cell-d_wishlist">
									<span class="wheart-d js_cart_wishlist" confirm="'.$this->diafan->_('Вы действительно хотите переместить товар из корзины в избранное?', false).'" title="'.$this->diafan->_('В избранное', false).'">
										<input class="wheart-d__input" type="checkbox" id="wish'.$row["id"].$rand.'" name="wishlist'.$row["id"].'" value="1">
										<label class="wheart-d__icon icon-d far fa-heart" for=""></label>
									</span>
								</div>';
