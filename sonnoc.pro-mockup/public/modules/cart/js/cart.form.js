...
var cart_form = function(){
	var self = {
		...
		events: function(){
			...
			$(document).on('click', _('form.item.wishlist'), self.wishlist);
		...
		wishlist: function(){
			if ($(this).attr(__('form.item.wishlist.attr.confirm')) && ! confirm($(this).attr(__('form.item.wishlist.attr.confirm')))) {
				return false;
			}
		},
		submit: function(){
