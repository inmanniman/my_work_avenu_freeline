...
class Swiper_install extends Install
{
	/**
	 * @var string название
	 */
	public $title = "Свайперы";
		...
		array(
			...
			"fields" => array(
				...
				array(
					...
					"comment" => "идентификатор основного альбома из таблицы {swiper_category}",
				),
				array(
					"name" => "site_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
		...
		array(
			...
			"fields" => array(
				...
				array(
					"name" => "element_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор фотографии из таблицы {swiper}",
				),
				array(
					"name" => "rel_element_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор связанной фотографии из таблицы {swiper}",
				),
				array(
					"name" => "trash",
					"type" => "ENUM('0', '1') NOT NULL DEFAULT '0'",
		...
		array(
			...
			"fields" => array(
				...
				array(
					"name" => "spaceBetween",
					"type" => "TEXT",
					"comment" => "Расстояние между слайдами в пикселях.
				...
				array(
					"name" => "effects",
					"type" => "TEXT",
					"comment" => "Анимированые эффекты. Доступны следующие эффекты: Fade Cube Coverflow Flip Cards Creative",
					"multilang" => true,
				),
				array(
					"name" => "changefreq",
				...
				array(
					"name" => "parent_id",
					"type" => "INT(11) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор родителя из таблицы {swiper_category}",
				),
				array(
					"name" => "count_children",
		...
		array(
			...
			"fields" => array(
				...
				array(
					"name" => "element_id",
					"type" => "INT( 11 ) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор альбома из таблицы {swiper_category}",
				),
				array(
					"name" => "parent_id",
					"type" => "INT( 11 ) UNSIGNED NOT NULL DEFAULT '0'",
					"comment" => "идентификатор альбома-родителя из таблицы {swiper_category}",
				),
				array(
					"name" => "trash",
					"type" => "ENUM( '0', '1' ) NOT NULL DEFAULT '0'",
	...
	public $site = array(
		array(
			"name" => array('Фотогалерея', 'Swipergallery'),
			"act" => true,
			"module_name" => "swiper",
			"rewrite" => "swiper",
			"menu" => 1,
	...
	public $admin = array(
		array(
			...
			"children" => array(
				...
				array(
					"name" => "Альбомы",
					"rewrite" => "swiper/category",
					"act" => true,
				),
				array (
					'name' => 'Статистика',
					'rewrite' => 'swiper/counter',
					'act' => true,
				),
				array(
					"name" => "Настройки",
					"rewrite" => "swiper/config",
				),
			)
		),
	);
	...
	public $demo = array(
		...
		'swiper_category' => array(
			array(
				'name' => array('Фотографии наших покупателей', 'Swipers of our buyers'),
				'rewrite' => 'swiper/users',
			),
			array(
				'name' => array('Палатки', 'Tents'),
				'rewrite' => 'swiper/palatki',
			),
		),
		'swiper' => array(
			array(
			...
			array(
				...
				'rewrite' => 'swiper/users/akita-super',
			),
			array(
				'id' => 4,
			...
			array(
				...
				'rewrite' => 'swiper/palatki/moy-dom-palatka',
			),
			array(
				'id' => 17,
				...
				'rewrite' => 'swiper/palatki/sinyaya-palatka-u-predgorya',
			),
			array(
				'id' => 16,
				...
				'rewrite' => 'swiper/palatki/vnutri-palatki',
			),
			array(
				'id' => 15,
				...
				'rewrite' => 'swiper/palatki/zheltaya-palatka',
			),
			array(
				'id' => 14,
				...
				'rewrite' => 'swiper/palatki/dve-palatki',
			),
			array(
				'id' => 13,
				...
				'rewrite' => 'swiper/palatki/palatka-s-navesom',
			),
			array(
				'id' => 12,
				...
				'rewrite' => 'swiper/palatki/palatka-garazh',
			),
			array(
				'id' => 11,
				...
				'rewrite' => 'swiper/palatki/palatka-s-navesom-v-lesu',
			),
			array(
				'id' => 10,
				...
				'rewrite' => 'swiper/palatki/palatka-korichnevaya',
			),
			array(
				'id' => 9,
				...
				'rewrite' => 'swiper/palatki/palatka-greenel',
			),
			array(
				'id' => 8,
				...
				'rewrite' => 'swiper/palatki/zelenaya-palatka',
			),
			array(
				'id' => 7,
