...
/**
 * Swiper_admin_category
 */
class Swiper_admin_category extends Frame_admin
{
	/**
	 * @var string таблица в базе данных
	 */
	public $table = 'swiper_category';
	...
	public $variables = array (
		'main' => array (
			...
			'spaceBetween' => array(
				'type' => 'text',
				'name' => 'spaceBetween',
				'help' => 'Расстояние между слайдами в пикселях.
			...
			'effects' => array(
				'type' => 'text',
				'name' => 'effects',
				'help' => 'Анимированые эффекты. Доступны следующие эффекты: Fade Cube Coverflow Flip Cards Creative',
				'multilang' => true,
			),
			'dynamic' => array(
				'type' => 'function',
