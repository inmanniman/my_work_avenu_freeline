 ...
 * Swiper_admin_config
 */
class Swiper_admin_config extends Frame_admin
{
	/**
	...
	public $variables = array (
		'config'       => array (
			...
			'rewrite_tpl' => array(
				'type' => 'text',
				'name' => 'Шаблон для автоматического генерирования ссылки у фотографий',
			...
			'rewrite_tpl_cat' => array(
				'type' => 'text',
				'name' => 'Шаблон для автоматического генерирования ссылки у альбомов',
			...
			'theme_list' => array(
				...
				'help' => 'По умолчанию modules/swiper/views/swiper.view.list.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			'view_list' => array(
				'type' => 'none',
				'hide' => true,
			...
			'theme_list_rows' => array(
				...
				'help' => 'По умолчанию modules/swiper/views/swiper.view.rows.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате. Значение параметра важно для AJAX.',
			),
			...
			'theme_first_page' => array(
				...
				'help' => 'По умолчанию modules/swiper/views/swiper.view.fitst_page.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			...
			'theme_first_page_rows' => array(
				...
				'help' => 'По умолчанию modules/swiper/views/swiper.view.fitst_page.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате. Значение параметра важно для AJAX.',
			),
			...
			'theme_id' => array(
				...
				'help' => 'По умолчанию, modules/swiper/views/swiper.view.id.php. Параметр для разработчиков! Не устанавливайте, если не уверены в результате.',
			),
			'view_id' => array(
				'type' => 'none',
				'hide' => true,
