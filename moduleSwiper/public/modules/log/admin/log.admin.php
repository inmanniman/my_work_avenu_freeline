...
<i class="fa fa-warning"></i><b>'.$this->diafan->_('Внимание! Это раздел для веб-мастера!').'</b><br>'.$this->diafan->_('Данный модуль отображает содержимое хостингового файла error.log').'</div>';
	...
	{
		ob_end_clean();
		$file = ABSOLUTE_PATH.Dev::LOG_ERRORS_PATH;
		$RFILE = fopen($file, "r+b") or die("Can't open log!");
		header('Content-Description: File Transfer');
		header('Content-Type: application/octet-stream');
		header('Content-Disposition: attachment; filename=error.'.MAIN_DOMAIN.'.log');
