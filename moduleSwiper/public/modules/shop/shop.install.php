...
class Shop_install extends Install
{
	...
	public $config = array(
		...
		array(
			"name" => "subject",
			"value" => array(
				"Ваш заказ %id на сайте %url",
				"Your order %id on %url",
			),
		),
		array(
			"name" => "message",
	...
	public $sql = array(
		...
		"shop_order_param" => array(
			...
			array(
				"id" => 11,
				"name" => array("Я не робот", "I'm not a robot"),
				"type" => "checkbox",
				"sort" => 11,
				"required" => 1,
				"show_in_form" => 1,
