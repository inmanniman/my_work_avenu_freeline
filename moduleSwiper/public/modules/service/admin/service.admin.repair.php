...
<i class="fa fa-warning"></i><b>'.$this->diafan->_('Внимание! Это раздел для веб-мастера! Вносите изменения, только если знаете, что делаете!').'</b><br>'.$this->diafan->_('Данный модуль предназначен для проверки соответствия структуры, описанной в файлах модулей (/modules/*/admin/*.admin.php в массиве $variables) реальным таблицам в базе данных DIAFAN.CMS. Рекомендуется запускать после обновления CMS с предыдущих версий, либо после программных доработок системы.').'</div>';
