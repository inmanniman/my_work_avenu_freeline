...
$files = array(Custom::path('adm/css/errors.css?v=7'));

$files[] = Custom::path('css/custom-theme/jquery-ui-1.8.18.custom.css?v=7');
...
if(is_array($compress_files))
{
	...
	{
		echo '<link href="'.BASE_PATH.$file.'?v=7" rel="stylesheet" type="text/css">';
	}
}
else
{
	echo '<link href="'.BASE_PATH.$compress_files.'?v=7" rel="stylesheet" type="text/css">';
}

if ($this->diafan->_users->useradmin)
{
	echo '<link href="'.BASE_PATH.Custom::path('modules/useradmin/useradmin.css').'?v=7" rel="stylesheet" type="text/css">';
}