...
echo '<section id="delivery-and-questions" class="delivery-and-questions container">';
echo '<h3 class="delivery-and-questions__title base-title">Доставка и оплата</h3>';
echo '<div class="delivery-and-questions__subtitle">Способ оплаты</div>';
echo '<div class="delivery-and-questions__wrapper-block">';
foreach ($result as $i => $row)
{

    echo '<details class="delivery-and-questions__block" open>';
...
echo '</div>';
echo '<div class="delivery-and-questions__subtitle">Способ получения</div>';
echo $this->htmleditor('<insert name="show_block" module="bs" cat_id="11" count="10" template="payment"></insert>');
