...
echo '<div class="news_list_page">';
//вывод списка новостей
foreach ($result["rows"] as $row)
{		           
	echo '<div class="news_list_page--item">';
		...
		foreach ($row["img"] as $img)
		{
			switch($img["type"])
			{
				...
				case 'large_image':
					...
					break;
				default:
					echo '<a href="'.BASE_PATH_HREF.$img["link"].'" class="news_list_page--img">';
					break;
			}
	...
	echo '<div class="news_list_page--text">';
