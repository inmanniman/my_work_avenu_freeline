...
echo '<script src="'.BASE_PATH.File::compress(Custom::path('js/site.js'), 'js').'"></script>';
...
if ($this->diafan->_users->useradmin)
{
	...
	<script defer src="'.BASE_PATH.File::compress(Custom::path('modules/useradmin/js/useradmin.js'), 'js').'"></script>';
}
...
{
	echo '
	<script defer src="'.BASE_PATH.File::compress(Custom::path('js/jquery.fancybox.min.js'), 'js').'"></script>';
}
...
foreach($this->diafan->_site->js_view as $path)
{
	...
	if (substr($path, 0, 4) != 'http')
	{
		...
		{
			echo '
		<script defer src="'.BASE_PATH.File::compress(Custom::path($path), 'js').'"></script>';
		}
	}
	else
	{
