...
echo '<section class="catalog-leasing catalog-leasing__leasing">';

echo '<div class="container">';
echo '<div class="leasing-leasing__header">' . $this->diafan->_('Размер месячного <br>платежа за технику') . '</div>';

echo '<div class="catalog-leasing__aside">';
echo $this->get('rows_rel' . '_leasing', 'shop', $result);
echo '</div>';
