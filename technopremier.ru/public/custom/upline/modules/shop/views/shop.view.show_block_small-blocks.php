...
if(! empty($result['rows']))
{
	echo '<div class="small-blocks container-main">
	<h3 class="small-blocks__title">
	';
	echo $this->htmleditor('<insert value="Популярные модели техники">');
	echo '</h3>';
		echo '<div class="small-blocks__content">';
			echo $this->get('rows_rel' . '_small-blocks', 'shop', $result);
		echo '</div>';
	echo '</div>';
}
