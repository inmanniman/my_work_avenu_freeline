...
echo '<div class="banner__content container">';
...
foreach ($result as $row)
{
    ...
    echo '<span class="banner__txt"><strong>'.$row['name'].'</strong> '.$row['alt'].'&nbsp;<span
            class="banner__five-min"><strong>'.$row['title'].'</strong></span></span>';

    if (! empty($row['text']))
    {
        echo '<a class="banner__btn" data-fancybox data-src="#dialog-kp">';
            echo '<span class="banner__btn-txt">'.strip_tags($row['text']).'</span>';
        echo '</a>';
    }
