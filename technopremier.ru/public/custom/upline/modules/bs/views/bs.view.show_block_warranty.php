...
echo '<section class="warranty">';
echo '<div class="warranty__content container">';
...
foreach ($result as $row)
{
	...
	if (! empty($row['image']))
	{
        echo '<div class="warranty__img-wrapper">';
		echo '<img class="warranty__img" loading="lazy" src="'.BASE_PATH.USERFILES.'/bs/'.$row['image'].'" alt="'.(! empty($row['alt']) ? $row['alt'] : '').'" title="'.(! empty($row['title']) ? $row['title'] : '').'">';
    }
