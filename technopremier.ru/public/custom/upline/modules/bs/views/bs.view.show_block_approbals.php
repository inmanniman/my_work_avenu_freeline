...
echo '<ol class="approbals__list container">';
...
foreach ($result as $row)
{
    ...
    echo '<li class="approbals__box">';

        if (! empty($row['name']))
        {
            echo '<div class="approbals__number">'.$row['name'].'</div>';
        }

        if (! empty($row['text']))
        {
            echo '<div class="approbals__box-content">'.$row['text'].'
                     <span class="approbals__desc">'.$row['alt'].'
                     <span class="approbals__desc_little">'.$row['title'].'</span>
                  <div>';
        }
