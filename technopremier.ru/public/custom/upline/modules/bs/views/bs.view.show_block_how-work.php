...
foreach ($result as $row)
{
    ...
    echo '<li class="how-work__box">';

    if (! empty($row['name']))
	{
        echo '<div class="how-work__number">'.$row['name'].'</div>';
	}

    if (! empty($row['text']))
    {
        echo '<span class="how-work__desc">'.strip_tags($row['text']).'</span>';
    }
