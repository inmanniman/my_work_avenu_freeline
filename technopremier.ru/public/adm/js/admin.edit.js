				...
				if(response.errors){
					...
					$.each(response.errors, function (k, val) {
						if(k) {
							...
							if(! focus)
							{
								var textfield = $("#"+k).find("input[type=text], submit, textarea");
								if(textfield.length)
								{
								...
								{
									$("#"+k).append('<input type="text">');
									$("#"+k+" input[type=text]").focus().remove();
								}
								focus = true;
							}
						}
						else
						{
							...
							if(! focus)
							{
								$(".nav-box-wrap").next('.error').after('<input type="text" id="main_error">');
								$("#main_error").focus().remove();
								focus = true;
							}
						}
					});
