	...
	public $variables = array (
		'base' => array (
			...
			'mobile_version' => array(
				...
				'help' => 'Если отмечено, то CMS будет автоматически определять устройство, с которого зашли на сайт и если это мобильное устройство, то автоматически будет загружаться дополнительный шаблон дизайна themes/m/site-start.php.',
			),
			'mobile_path' => array(
				'type' => 'text',
