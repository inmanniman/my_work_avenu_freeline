...
class Site extends Controller
{
	 ...
	 * template - шаблон тега (файл modules/site/views/site.view.show_block_**template**.php; по умолчанию шаблон modules/site/views/site.view.show_block_how-work-one-block.php)
	 *
	 * @return void
	 */
