...
class Shop_model extends Model
{
	...
	public function id()
	{
		...
		$this->result["comments_count"] = DB::query_result("SELECT COUNT(id) FROM {comments} WHERE module_name='shop' AND element_id=%d AND element_type='element' AND act='1' AND trash='0'", $this->result['id']);
