...
if($current)
{
	...
	echo '<span class="breadcrumb-d" itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem"><meta itemprop="item" content="http'.(IS_HTTPS ? "s" : '').'://'.$_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'].'"><span itemprop="name"><span itemprop="name">'.$name.'</span><meta itemprop="position" content="'.$position.'"></span>';
}
echo '</nav>';
