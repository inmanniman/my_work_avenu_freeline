...
echo '<section class="infoImg graph section-mg56 bg-gray">
        <div class="infoImg__inner container">
            <div class="infoImg__info">';
            ...
            echo '<a href="';
            if (! empty($result[0]['link']))
            {
                echo $result[0]['link'];
            }
            echo '" data-path="contact" class="infoImg__link link-arrow callModal-1">'.$this->diafan->_('Инвестировать') .'
            ...
            <div class="infoImg__img graph__box">
                <div class="graph__name">'.$this->diafan->_('graph-title') .'</div>';
                echo $this->diafan->_tpl->htmleditor('<insert name="show_block" module="site" id="3" template="easy">');
		    echo '</div>
        </div>
    </section>';
