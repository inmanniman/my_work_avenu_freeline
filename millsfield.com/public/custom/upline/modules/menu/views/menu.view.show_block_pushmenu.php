...
echo '<ul class="nav__list" itemscope itemtype="http://www.schema.org/SiteNavigationElement">';
if(! empty($result["name"]))
{
	echo '<li class="nav__name">'.$result["name"].'</li>';
}
echo $this->get('show_level_pushmenu', 'menu', $result);
echo '</ul>';