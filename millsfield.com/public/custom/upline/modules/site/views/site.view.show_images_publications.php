...
if (empty($result["images"]))
{
 ...
 if(! empty($result["images"][0]['src'])){
	...
	echo '<section class="front section-mg28 articles-list front front_min" style="background-image: url(' .$result["images"][0]['src'] .');">';	 
 }
 else
 {
	echo '<section class="front section-mg28 articles-list front front_min">';	 
 }
