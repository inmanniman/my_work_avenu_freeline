...
echo '<form action="" id="form-1" class="form contact ajax" method="POST" enctype="multipart/form-data">
	...
	echo '<div class="modal__content">
		<h3 class="modal__title">
			<span class="title_1">
				' . $this->diafan->_('title-invest-form') . '
			</span>
			<span class="title_2">
				'.  $this->diafan->_('title-invest-form-mob') . '
			</span>
		</h3>';
	...
	echo '<!-- КОНЕЦ: form--> </div><a href="javascript://" data-modalClass="modal1" class="modal__close"></a>';
	echo '</form>';
