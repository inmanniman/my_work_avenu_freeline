<?php
/**
 * шаблон для статей в разделе Публикации
 *
 * @package    DIAFAN.CMS
 * @author     diafan.ru
 * @version    7.0
...
<!-- <insert name="show_include" file="mheader"></insert> -->
    ...
    <!-- код insert скопирован в начало шаблона новости (news.view.id); для вставки картинки новости в элемент с бекграундом, который описан в данном insert -->
	<!-- <insert name="show_images" module="site" template="article"></insert> -->

<!-- закоментированные ниже элементы перенесены в show_module -->
    <!-- <div class="container">
        <div class="page__inner">
            ...
            <ASIDE class="right-side" itemscope itemtype="http://schema.org/WPSideBar">
