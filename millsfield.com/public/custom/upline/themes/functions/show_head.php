...
echo '<meta property="og:title" content="';
	$this->functions('show_title', array());
echo '">
';
echo '<meta property="og:description" content="';
	$this->functions('show_description', array());
echo '">
';
echo '<meta property="og:url" content="/'.$this->diafan->_route->current_link().'">
';
echo '<meta property="og:image" content="/custom/upline/assets/img/logo2.svg">
';