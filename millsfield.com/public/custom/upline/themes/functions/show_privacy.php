...
$text = (! empty($text) ? $text : $this->diafan->_('На этом сайте используются файлы cookie. Продолжая просмотр сайта, вы разрешаете их использование. %sПодробнее%s.', true, '<a class="call-privacy-policy" href="#modal-pp">', '</a>'));
